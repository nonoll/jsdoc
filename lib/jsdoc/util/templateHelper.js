...
function sort(member) {
    return member.sort(function(a, b) { return a.sort <= b.sort ? -1 : 1; });
}
/**
...
exports.getMembers = function(data) {
    var members = {
        classes: sort(find( data, {kind: 'class'} )),
        externals: find( data, {kind: 'external'} ),
        events: sort(find( data, {kind: 'event'} )),
        globals: find(data, {
            kind: ['member', 'function', 'constant', 'typedef'],
            memberof: { isUndefined: true }
        }),
        mixins: find( data, {kind: 'mixin'} ),
        modules: sort(find( data, {kind: 'module'} )),
        namespaces: sort(find( data, {kind: 'namespace'} )),
        interfaces: sort(find( data, {kind: 'interface'} ))
    };
